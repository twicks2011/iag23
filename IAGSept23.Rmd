...
.pull-left[
### Core Mathematics
**Staff:** Tom Wicks, Matthias Kurzke, Joel Feinstein, Al Kasprzyk, Sergei Oblezin, Johannes Hofscheier
...
### Algebra
**Staff:** Dan Nicks, Fredrik Strömberg, Chris Williams, Nikos Diamantis
...
Students must produce a 5-minute presentation to summarise their findings. The primary format is a live in-person presentation, but groups have the option to present asynchronously if they prefer by submitting a video presentation.

Training will be provided in workshops prior to the project week and during the week on general presentation skills and on recommended software/hardware for producing videos (where needed).

Assessment criteria will focus on the effectiveness and accuracy of mathematical communication, including audience awareness. We do not want to give an unfair advantage to students with good video-editing skills!
...
Live presentations will be given in staggered seminar-style sessions at the end of the project week. With students' permission, presentation videos will be shared with the rest of the cohort.
]
]
...
---
## Tutorials
* Weekly session with personal tutor in groups of 5-6.
* Students submit work before tutorial for feedback.
* Tutorial questions related to pre-work.
  * Tutor can follow up directly on development areas.
  * Tutor can select questions strategically.
* Opportunities for group discussion of more involved problems, where basics are covered in the pre-work.
* Some tutorial support for other assessments, such as ePortfolio and group projects.
---
